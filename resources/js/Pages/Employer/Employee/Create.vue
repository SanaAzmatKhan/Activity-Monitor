            ...
            <div class="col-md-2"></div>
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form @submit="create_employee" id="create_employee" method="post" enctype="multipart/form-data" :action="route('employer.employee.store')">
                            <div class="card-body">
...
export default {
        ...
        methods: {
          create_employee($e) {
               ...
               let url = route('employer.employee.store');
               axios.post(url, data).then((response) => {
                   form.find("button[type=submit]").attr("disabled", false);
                   form.find("button[type=submit]").find(".loader").addClass('d-none');
                   form[0].reset();
                   $(".msg-box").html('<div class="alert alert-success"><strong>Success!</strong> Employee created.</div>');
